...
Vectors : build\main.o build\coord_system.o build\vectors.o
	g++ $(SFML_LIBS) build\main.o build\coord_system.o build\vectors.o -o Vectors.exe -lsfml-graphics-s -lsfml-window-s -lsfml-system-s -lopengl32 -lfreetype -lwinmm -lgdi32 -lsfml-main -mwindows
